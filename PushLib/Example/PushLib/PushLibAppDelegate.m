//
//  PushLibAppDelegate.m
//  PushLib
//
//  Created by samuel.ferreira on 04/26/2016.
//  Copyright (c) 2016 samuel.ferreira. All rights reserved.
//

#import "PushLibAppDelegate.h"
#import "PushManager.h"

@implementation PushLibAppDelegate
...
-(void)application:(UIApplication *)application didRegisterForRemoteNotificationsWithDeviceToken:(NSData *)deviceToken
{
    //Sample
        [PushManager sharedInstance:[PushClientData pushClientDataWithBlock:^(PushClientDataBuilder *clientDataBuilder) {
                ...
                clientDataBuilder.pushDomainUrl = @"https://realwave.gateway.zup.me";
